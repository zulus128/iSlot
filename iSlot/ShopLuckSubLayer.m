...
-(void) addContent {
    ...
    label5 = [CCLabelTTF labelWithString:@"Luck: +5" fontName:MAINFONT fontSize:20];
    label5.position =  ccp(140, 80);
    label5.color = ccc3(0, 0, 0);
    label5.tag = SHOPLUCK_TAG;
    [item5 addChild: label5];
    label51 = [CCLabelTTF labelWithString:@"Duration:" fontName:MAINFONT fontSize:20];
    label51.position =  ccp(140, 50);
    label51.color = ccc3(0, 0, 0);
    label51.tag = SHOPLUCK_TAG;
    [item5 addChild: label51];
    label52 = [CCLabelTTF labelWithString:@"30 minutes" fontName:MAINFONT fontSize:20];
    ...
    label10 = [CCLabelTTF labelWithString:@"Luck: +10" fontName:MAINFONT fontSize:20];
    label10.position =  ccp(140, 80);
    label10.color = ccc3(0, 0, 0);
    label10.tag = SHOPLUCK_TAG;
    [item10 addChild: label10];
    label101 = [CCLabelTTF labelWithString:@"Duration:" fontName:MAINFONT fontSize:20];
    label101.position =  ccp(140, 50);
    label101.color = ccc3(0, 0, 0);
    label101.tag = SHOPLUCK_TAG;
    [item10 addChild: label101];
    label102 = [CCLabelTTF labelWithString:@"1 hour" fontName:MAINFONT fontSize:20];
    ...
    label20 = [CCLabelTTF labelWithString:@"Luck: +20" fontName:MAINFONT fontSize:20];
    label20.position =  ccp(140, 80);
    label20.color = ccc3(0, 0, 0);
    label20.tag = SHOPLUCK_TAG;
    [item20 addChild: label20];
    label201 = [CCLabelTTF labelWithString:@"Duration:" fontName:MAINFONT fontSize:20];
    label201.position =  ccp(140, 50);
    label201.color = ccc3(0, 0, 0);
    label201.tag = SHOPLUCK_TAG;
    [item20 addChild: label201];
    label202 = [CCLabelTTF labelWithString:@"3 hour" fontName:MAINFONT fontSize:20];
    ...
    label25 = [CCLabelTTF labelWithString:@"Luck: +25" fontName:MAINFONT fontSize:20];
    label25.position =  ccp(140, 80);
    label25.color = ccc3(0, 0, 0);
    label25.tag = SHOPLUCK_TAG;
    [item25 addChild: label25];
    label251 = [CCLabelTTF labelWithString:@"Duration:" fontName:MAINFONT fontSize:20];
    label251.position =  ccp(140, 50);
    label251.color = ccc3(0, 0, 0);
    label251.tag = SHOPLUCK_TAG;
    [item25 addChild: label251];
    label252 = [CCLabelTTF labelWithString:@"6 hour" fontName:MAINFONT fontSize:20];
    ...
    label35 = [CCLabelTTF labelWithString:@"Luck: +35" fontName:MAINFONT fontSize:20];
    label35.position =  ccp(140, 80);
    label35.color = ccc3(0, 0, 0);
    label35.tag = SHOPLUCK_TAG;
    [item35 addChild: label35];
    label351 = [CCLabelTTF labelWithString:@"Duration:" fontName:MAINFONT fontSize:20];
    label351.position =  ccp(140, 50);
    label351.color = ccc3(0, 0, 0);
    label351.tag = SHOPLUCK_TAG;
    [item35 addChild: label351];
    label352 = [CCLabelTTF labelWithString:@"12 hour" fontName:MAINFONT fontSize:20];
    ...
    label50 = [CCLabelTTF labelWithString:@"Luck: +50" fontName:MAINFONT fontSize:20];
    label50.position =  ccp(140, 80);
    label50.color = ccc3(0, 0, 0);
    label50.tag = SHOPLUCK_TAG;
    [item50 addChild: label50];
    label501 = [CCLabelTTF labelWithString:@"Duration:" fontName:MAINFONT fontSize:20];
    label501.position =  ccp(140, 50);
    label501.color = ccc3(0, 0, 0);
    label501.tag = SHOPLUCK_TAG;
    [item50 addChild: label501];
    label502 = [CCLabelTTF labelWithString:@"24 hour" fontName:MAINFONT fontSize:20];
