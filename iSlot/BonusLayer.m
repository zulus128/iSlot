...
-(id) init {
	...
	if( (self=[super init])) {
        ...
        CCMenuItem *i2 = [CCMenuItemImage itemFromNormalImage:@"ChestClosed.png" selectedImage:@"ChestClosed.png" target:nil selector:nil];
        CCMenuItem *ii2 = [CCMenuItemImage itemFromNormalImage:@"ChestOpen.png" selectedImage:@"ChestOpen.png" target:nil selector:nil];
        ...
        CCMenuItem *i3 = [CCMenuItemImage itemFromNormalImage:@"ChestClosed.png" selectedImage:@"ChestClosed.png" target:nil selector:nil];
        CCMenuItem *ii3 = [CCMenuItemImage itemFromNormalImage:@"ChestOpen.png" selectedImage:@"ChestOpen.png" target:nil selector:nil];
        ...
        CCMenuItem *i4 = [CCMenuItemImage itemFromNormalImage:@"ChestClosed.png" selectedImage:@"ChestClosed.png" target:nil selector:nil];
        CCMenuItem *ii4 = [CCMenuItemImage itemFromNormalImage:@"ChestOpen.png" selectedImage:@"ChestOpen.png" target:nil selector:nil];
        ...
        CCMenuItem *i5 = [CCMenuItemImage itemFromNormalImage:@"ChestClosed.png" selectedImage:@"ChestClosed.png" target:nil selector:nil];
        CCMenuItem *ii5 = [CCMenuItemImage itemFromNormalImage:@"ChestOpen.png" selectedImage:@"ChestOpen.png" target:nil selector:nil];
        ...
        CCMenuItem *i6 = [CCMenuItemImage itemFromNormalImage:@"ChestClosed.png" selectedImage:@"ChestClosed.png" target:nil selector:nil];
        CCMenuItem *ii6 = [CCMenuItemImage itemFromNormalImage:@"ChestOpen.png" selectedImage:@"ChestOpen.png" target:nil selector:nil];
